...
namespace _20191121_SP
{
    public partial class FrmSistemaSolar : Form
    {
        ...
        private void FrmSistemaSolar_Load(object sender, EventArgs e)
        {
            ...
            {
                // Asociar Evento
                p.InformacionDeAvance+=DibujarAvancePlaneta;
        ...
        private void btnSimular_Click(object sender, EventArgs e)
        {
            ...
            if (this.btnSimular.Text == "Simular")
            {
                this.Text = "Sistema Solar " + this.btnSimular.Text.EstadoSimulacion(false);
            }
            else
            {
                this.Text = "Sistema Solar " + this.btnSimular.Text.EstadoSimulacion(true);
            }
