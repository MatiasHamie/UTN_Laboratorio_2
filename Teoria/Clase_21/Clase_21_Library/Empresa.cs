...
namespace Clase_21
{
    public class Empresa : ISerializable<string>
    {
        ...
        public Empresa(int id, string razonSocial, string direccion, float ganancias)
            : this(razonSocial, direccion, ganancias)
        {
            this._id = id;
        }
        ...
        public bool guardar()
        {
            return EmpresaDAO.InsertarEmpresa(this);
        }
        public bool leer(out string datos)
        {
            datos = EmpresaDAO.ObtenerEmpresa().MostrarEmpresa();
            if (datos == null)
                return false;
            else
                return true;
        ...
        {
            return EmpresaDAO.ModificarEmpresa(this);
        }
        public bool eliminar()
        {
            return EmpresaDAO.EliminarEmpresa(this);
        }
        #endregion
    }
}
