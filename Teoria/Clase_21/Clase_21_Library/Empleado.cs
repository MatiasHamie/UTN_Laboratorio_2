...
namespace Clase_21
{
    public class Empleado : Persona, ISerializable<Empleado>
    {
        ...
        public Empleado(int id, string nombre, string apellido, string legajo, EPuestoJerarquico puesto, int salario)
            : this(nombre, apellido,legajo,  puesto,  salario)
        {
            this._id = id;
        }
        ...
        public bool guardar()
        {
            return EmpleadoDAO.InsertarEmpleado(this);
        }
        public bool leer(out Empleado datos)
        {
            datos = EmpleadoDAO.ObtenerEmpleado(this);
            if (datos == null)
                return false;
            else
                return true;
        ...
        {
            return EmpleadoDAO.ModificarEmpleado(this);
        }
        public bool eliminar()
        {
            return EmpleadoDAO.EliminarEmpleado(this);
        }
        #endregion
    }
}
