...
namespace Clase_8
{
    public partial class frmEmpleado : Form
    {
        ...
        {
            Persona p = this.GenerarEmpleadoDesdeFormulario();
            // Agrego a la persona a la empresa
            this._empresa += p;
        ...
        private void leerToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (!persona.Equals(null))
            {
                ...
                {
                    Empleado empleado = new Empleado();
                    if (((Empleado)persona).leer(out empleado))
                    {
                        if (empleado != null)
                        {
